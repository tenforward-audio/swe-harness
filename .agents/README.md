...
| Durable technical rationale | [`decisions/`](decisions/), beginning with [repository authority](decisions/0001-repository-authority.md) |
...
this structure. The validator enforces links and ownership invariants; it does
